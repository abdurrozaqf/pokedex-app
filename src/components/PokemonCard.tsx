...
const PokemonCard = (props: Props) => {
  ...
  return (
    <Link to={`/detail-pokemon/${data.id}`}>
      <div className="w-[11rem] h-auto md:w-[16rem] md:h-[20rem] bg-white dark:bg-slate-800/50 border-collapse border-4 dark:border-white/25 shadow-lg dark:shadow-neutral-300/20 rounded-lg flex flex-col justify-between items-center pt-4 border-black overflow-auto">
        <figure>
          <img
